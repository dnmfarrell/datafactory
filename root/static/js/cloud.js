...
var words = [],
    ...
    fontSize,
    maxLength = 30,
    fetcher = "http://datafactory.co.uk/gobbletest/{word}/json",
...
var tabs = d3.select("#presets").selectAll("a")
    .data([
      {fetcher: "http://datafactory.co.uk/gobbletest/{word}/json", name: "Twitter"},
